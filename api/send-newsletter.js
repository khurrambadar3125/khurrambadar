...
<div style="max-width:600px;margin:0 auto;background:#0C0E1A;border:1px solid rgba(201,146,31,0.2);">
  ...
  <div style="padding:20px 28px;border-top:1px solid rgba(201,146,31,0.15);text-align:center;">
    ...
    <div style="margin:0 0 16px;">
      ...
      <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fkhurrambadar.com%2Fdaily&quote=${encodeURIComponent(`KRM Daily Brief — Gold $${gold} | Silver $${silver} | DXY ${dxy}`)}" style="display:inline-block;padding:8px 16px;margin:4px;background:#1877F2;color:#fff;text-decoration:none;border-radius:6px;font-family:'Courier New',monospace;font-size:12px;font-weight:bold;">Facebook</a>
      <a href="https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fkhurrambadar.com%2Fdaily" style="display:inline-block;padding:8px 16px;margin:4px;background:#0A66C2;color:#fff;text-decoration:none;border-radius:6px;font-family:'Courier New',monospace;font-size:12px;font-weight:bold;">LinkedIn</a>
      <a href="https://t.me/share/url?url=https%3A%2F%2Fkhurrambadar.com%2Fdaily&text=${encodeURIComponent(`KRM Daily Brief — ${date}\\nGold $${gold} | Silver $${silver} | DXY ${dxy}`)}" style="display:inline-block;padding:8px 16px;margin:4px;background:#0088cc;color:#fff;text-decoration:none;border-radius:6px;font-family:'Courier New',monospace;font-size:12px;font-weight:bold;">Telegram</a>
      ...
      <a href="https://whatsapp.com/channel/0029Vb7pkVi8kyyUhjU06q2H" style="display:inline-block;padding:8px 16px;margin:4px;background:#25D366;color:#fff;text-decoration:none;border-radius:6px;font-family:'Courier New',monospace;font-size:12px;font-weight:bold;">Follow on WhatsApp</a>
    </div>
