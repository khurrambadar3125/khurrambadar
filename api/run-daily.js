...
<a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fkhurrambadar.com%2Fdaily&quote=${encodeURIComponent(`KRM Daily Brief — Gold $${brief.gold_price||''} | Silver $${brief.silver_price||''} | DXY ${brief.dxy||''}`)}" style="display:inline-block;padding:6px 14px;margin:3px;background:#1877F2;color:#fff;text-decoration:none;border-radius:5px;font-family:monospace;font-size:11px;font-weight:bold;">Facebook</a>
