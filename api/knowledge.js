...
APR 13 (SUN — BLOCKADE): US NAVAL BLOCKADE ANNOUNCED. All Iranian ports blockaded from 10 AM ET. Oil surged 7%+ to $102. Gold $4,717 (-0.63%). Silver $74.25 (-2%). DXY 98.98 (+0.33%). S&P futures -0.55 to -1.1%. BTC $70,807. Ceasefire technically active BUT blockade = escalation within ceasefire. Iran FM: "economic warfare, violation of international law." Talks collapsed in Islamabad after 21 hours — nuclear issue was blocking point. Vance left "final offer." US mine clearance continues in Hormuz. Ships can transit Hormuz between non-Iranian ports but all Iranian port traffic blocked.
LESSON 037 (April 13, 2026) — BLOCKADE IS ESCALATION WITHIN CEASEFIRE:
A naval blockade is an act of war under international law. The US is simultaneously maintaining a ceasefire AND blockading all Iranian ports. This is a contradiction that markets haven't fully processed. Oil surged 7% on the blockade but did NOT return to pre-ceasefire $110+ levels. The market is pricing: (a) blockade is real, (b) ceasefire still limits full escalation, (c) Hormuz transit for non-Iranian ships reduces the worst-case. RULE: When contradictory policies coexist (ceasefire + blockade), oil trades in the middle of the range ($100-105), not at the extremes ($90 or $120).

APR 14 (TUE — RISK-ON METALS + MEDIATORS MOVE): Gold $4,773.90 (+0.72%). Silver $77.69 (+2.98% — leading the move). DXY 98.21 (-0.21%). Brent $98.71 (-0.65%, cooling off Monday's blockade spike). 10Y 4.297%. S&P 6,886.24 (+1.02%). BTC $74,552 (+5.27%). Pakistani, Egyptian and Turkish mediators actively working to restart US-Iran talks before the April 21 ceasefire expiry. Vance: "the ball is in the Iranian court." Key sticking point is removal of Iran's enriched uranium + verification measures. US broke off prior talks after concluding Iran violated ceasefire by failing to reopen Hormuz. Structural signal: CENTRAL BANKS NOW HOLD MORE GOLD THAN DOLLARS for the first time since Bretton Woods collapse ($3.87 trillion gold vs $3.73 trillion dollars). ETFs added 21 tonnes in a COOLING market — portfolio allocation, not panic hedge.
LESSON 038 (April 14, 2026) — MEDIATORS + HARD DEADLINE = BIMODAL PRICING, SILVER LEADS:
When talks fail but mediators actively work to restart before a hard deadline (here: April 21 ceasefire expiry), markets price a bimodal outcome — deal or war resumes. The deadline becomes a forcing function. In that setup: (a) oil compresses toward the middle of a wider range ($95-102), not extremes, because both outcomes are visible; (b) gold holds gains because the uncertainty premium persists even in a risk-on session; (c) silver OUTPERFORMS gold (gold-silver ratio compresses) because silver is the risk-on expression of the precious metals trade. Today was classic: silver +2.98% vs gold +0.72% — a 4.1x multiplier. When you see that multiplier with DXY softer and oil cooling, you are in a "mediators working" tape, not a "war escalating" tape. RULE: The gold-silver ratio compression rate tells you which regime the market thinks it is in. GSR compressing fast (today ≈ 61.4) with oil down = bimodal/mediator regime. GSR expanding with oil up = war escalation regime.
LESSON 039 (April 14, 2026) — BRETTON-WOODS-ERA MARKER, IGNORE AT YOUR PERIL:
Central banks now hold more gold than dollars — $3.87T vs $3.73T. First time since the Bretton Woods collapse in 1971. This is not a cyclical data point. This is a regime change marker. Combined with 21 tonnes of ETF inflows during a COOLING tape (no crisis spike), institutions are making a portfolio-level allocation decision — gold as permanent allocation, not hedge. RULE: When central banks and institutions simultaneously reallocate to gold in a non-crisis tape, the structural floor rises. Raise your gold downside-support from $4,500 to $4,650. Raise year-end target conviction on Goldman's $5,400.

APR 15 (WED — COMPREHENSIVE): THE RESERVE REALLOCATION GOES PUBLIC. Gold $4,801 (reclaimed $4,800). Silver $78.66 (holding structural floor). DXY 98.20 — SIX-WEEK LOW. Oil (Brent) $96.24 (+1.53%) — Hormuz re-closed hours after reopening. 10Y 4.256% (-0.95%). S&P 6,967.38 (+1.18%). BTC $74,014 (-0.69%). Trump on Truth Social accused Iran of "very poor job" handling Hormuz traffic; hints US-Iran talks could resume over next two days. April 21 ceasefire expiry remains the forcing function. DXY at six-week low + gold reclaim + CB reserve reallocation accelerating = Signal 14 behaviour on a weak-DXY tape — now explained structurally by Thesis G (The Great Reserve Reallocation). Signal 15 officially added to the framework today. Scenarios: 40 drags / 35 escalation / 25 ceasefire.

LESSON 040 (April 15, 2026) — HORMUZ IS A PROMISE, NOT A PORT:
A ceasefire that re-closes the Strait of Hormuz within hours of letting tankers through is not a diplomatic success — it is escalation-by-logistics. Oil will price the promise, not the agreement. Today Brent rose 1.53% to $96.24 on a day gold reclaimed $4,800 and DXY hit a six-week low — a combination that should compress oil, not lift it. The mismatch is the Hormuz stumble being priced as re-escalation risk even while the rest of the tape reads "risk-on." RULE: When the Strait behaves inconsistently with the diplomatic headline, trust the Strait. Logistics is the honest signal. Headlines are the negotiating signal. If April 21 arrives and tanker volume through Hormuz is not back to 2-week averages, the Peace Dividend Trade is postponed regardless of what anyone says at a podium.

LESSON 041 (April 15, 2026) — THESIS G GOES LIVE: THE GREAT RESERVE REALLOCATION:
Added to the platform today as Thesis G and Signal 15. The argument: governments are dumping US Treasuries and rotating the proceeds directly into gold. In 2025 gold overtook US Treasuries as the largest share of global reserves for the first time in 30 years. CB buying 1,000+ tonnes annually for three consecutive years. 95% of surveyed CBs expect their gold reserves to rise in 2026. Japan ($1.2T) actively repatriating as JGB yields approach Treasury parity; China steadily reducing Treasury holdings in confirmed quarterly drawdowns. The mechanism — one trade, dual impact: CB sells Treasury → yields rise → same proceeds rotate into gold → gold rises AND dollar can rise too because the pressure is on dollar ASSETS, not the dollar itself. This is the structural source of Signal 14. The math: $12T FX reserves at 15-17% gold. A shift to 20% = $600B new demand / ~4,300 tonnes. Annual mine output is 3,500 tonnes. A 5% reserve shift exceeds entire annual mine output for 14+ months. Supply cannot respond. RULE: From today forward, read Signal 14 through the Thesis G lens. A DXY+gold co-rise is no longer a curiosity — it is the reallocation expressing itself in daily prices. Base case: gold $6,000-8,000 / silver $150-200 over 3-5 years. Bull case: $8,000-12,000 / $200-300. Silver carries 3-5x the percentage upside — ratio 62:1 compressing toward 40:1.
...
export default async function handler(req) {
  ...
  return new Response(JSON.stringify({ knowledge: KNOWLEDGE_BASE }), {
    status: 200,
    headers: {
